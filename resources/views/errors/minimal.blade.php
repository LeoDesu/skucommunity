...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .bg-222{background-color: #e7e7e7;}
        </style>
    </head>
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0 bg-222">
            <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center pt-8 sm:justify-start sm:pt-0">
                    <div class="px-4 text-lg border-r border-black tracking-wider">
                        <h3>@yield('code')</h3>
                    </div>
